...
def check():
    ...
    if not ("Author : Sh-Seam" in file) or not ("GitHub : https://github.com/Sh-Seam" in file) or not ("Sh-Seam" in file) or not ("https://raw.githubusercontent.com/Sh-Seam/seam/main/more/.version" in file):
