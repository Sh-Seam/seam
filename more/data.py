...
def check():
    ...
    if not ("Author : Sh-Seam" in file) or not ("GitHub : https://github.com/Sh-Seam/seam" in file) or not ("SeamBomber" in file) or not ("https://raw.githubusercontent.com/Sh-Seam/seam/main/more/.version" in file):
